...
negateByMul : Rat -> Rat
negateByMul (Div n1 n2) = Div n2 n1

solveRatPred : RatPred -> RatPred
solveRatPred p =
  case p of
    (Less t (ConstFact c x)) -> Less (ConstFact (negateByMul c) t) x
    p_ -> p_
...
solve p =
    case p of
        ...
        Exists p1 -> Exists (solve p1)

        Neg p1 -> Neg (solve p1) -- this case should not happen.
